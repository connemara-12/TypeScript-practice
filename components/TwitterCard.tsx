    ...
    <div className="bg-gray-200 pt-20 pb-80 flex items-center justify-center">
      <div className="bg-white border-gray-200 p-4 rounded-xl border max-w-xl min-w-[480px]">
        ...
        <div className="flex items-center">
          <div>
            <Image
              src="https://doodleipsum.com/200x200/avatar-5?bg=6392D9&i=0f33dd99912f70859db2eeaf52dd71f4"
              width={50}
              height={50}
              alt=""
          ...
          <div className="ml-1.5 text-sm leading-tight">
            <span className="text-black font-bold block ">しまぶー!!!</span>
            <span className="text-gray-500 font-normal block">shimabu_it</span>
          </div>
        </div>
        {/* 本文 */}
        <p className="text-black block text-xl leading-snug mt-3 mb-2">
          こんにちは！
        </p>

        <div>
          <Image
            src="https://doodleipsum.com/700x394/flat?bg=7463D9&i=c2a3b28fed2bb5d5690e9bab3ff2dce1"
            width={700}
            height={394}
            alt=""
